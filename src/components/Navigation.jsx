      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex md:items-center md:justify-end md:flex-1">
            {navItems.map((item) => (
              <Button key={item.to} asChild variant="ghost" className="w-1/3 text-cyber-text hover:text-cyber-accent hover:opaciy-75 hover:blur-sm hover:backdrop-invert-0 hover:bg-red/15">
