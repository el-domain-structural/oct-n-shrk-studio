    ...
    <div className="min-h-screen bg-cyber-background text-cyber-text">
      ...
      <div className="py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl font-bold text-center mb-12 text-cyber-accent cyber-glitch">OCTO & SHARK FOUNDATION</h1>
          <Card className="mb-8 bg-cyber-secondary bg-opacity-20 backdrop-filter backdrop-blur-lg border border-cyber-accent">
            ...
            <CardContent>
              <p className="mb-4 text-cyber-text">
                The OCTO & SHARK FOUNDATION is dedicated to advancing the fusion of humanity and technology. We believe that through Octo & Shark enhancements and digital interconnectivity, we can create a more advanced and harmonious society.
              </p>
